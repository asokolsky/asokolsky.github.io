...
5. Finally, lambda publishes message to the predefined [SNS topic](https://docs.aws.amazon.com/sns/latest/dg/welcome.html) outlining who changed which IaC object and when.
