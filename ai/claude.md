...
- MCP: [Intro](https://anthropic.skilljar.com/introduction-to-model-context-protocol),
  [Advanced Topics](https://anthropic.skilljar.com/model-context-protocol-advanced-topics)
