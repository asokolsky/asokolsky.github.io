...
1. Activate the Bluetooth function on your device and search for nearby Bluetooth
   connections.
1. Select “TaoTronics TT-SK017” from the search results and tap to connect.
1. The LED indicator will turn solid blue once connected.
