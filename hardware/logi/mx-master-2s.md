...
1. This mouse allows you to use it with up to three different computers. Just use the Easy-Switch™ button to change the channel. Select the channel you want and go to the next step.
1. To connect your mouse to your computer press the Easy-Switch™ button for 3 seconds. When it blinks fast it means it's in discoverable mode.
1. Choose if you want to pair with Bluetooth or with the provided Unifying receiver.
